...
### BTE constants
btheta = math.radians(-150)
bsin_theta = math.sin(btheta)
bcos_theta = math.cos(btheta)
bering_x, bering_y = -0.3420420960118339, -0.322211064085279  #-0.3282152608138795, -0.3281491467713469
artic_y = -0.2 #-0.3281491467713469
artic_m = (artic_y - math.sqrt(3) * garc / 4) / (bering_x + 0.5 * garc)
artic_b = artic_y - artic_m * bering_x
...
''' 
    {
        ...
        "useDefaultTreeCover":true,
        "skipChunkPopulation":["ICE"],
        "skipBiomeDecoration":["TREE"],
        "version":2
    }
'''
scale_x, scale_y = 7318261.522857145, 7318261.522857145